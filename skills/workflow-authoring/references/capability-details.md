...
Contract content / skill / extension: `3.5.1-yuki.3`
...
- Classification: `workflow-tool-input`
- Support: `supported`
- Signature: `agentTimeoutMs?: number = configured default or no per-agent limit`

<a id="tool-input-workflowtimeoutms"></a>
## workflowTimeoutMs
