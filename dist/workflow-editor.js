 ...
 */
const BACKGROUND_DELIVERY_REASSURANCE = "If you do call `workflow`, it runs in the background: this turn will end and the result is delivered back into the conversation automatically when it finishes — that's expected, not a stall, so you do not need to stay and block.";
/**
